...
interface ButtonAsLink extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
  href: string;
  variant?: ButtonVariant;
  size?: ButtonSize;
}
...
/**
 * Renders a <button> by default, or a real <a> when given an `href` —
 * keeps link semantics correct instead of nesting an anchor in a button.
 */
